        ...
        {/*
          ...
          */}
          <div className="form-group">
            <Button bsSize="sm" bsStyle="success" block onClick={this.handleRightPanelButtonClick.bind(this, DETAIL_SUBMITTED)}>Submit For Approval</Button>
          </div>
        ...
        <div className="sidebar-details">
          <div className="workflow-avatars col-md-12">
            ...
            <OverlayTrigger placement="bottom" overlay={tooltipOwner}>
              <Avatar src="/static/images/a1.jpg" status="pending" shape="circle" size=""/>
            </OverlayTrigger>
            <div className="divider-vertical"></div>
            <OverlayTrigger placement="bottom" overlay={tooltipApprover1}>
              <Avatar src="/static/images/a2.jpg" status="" shape="circle" size=""/>
            </OverlayTrigger>
            <OverlayTrigger placement="bottom" overlay={tooltipApprover2}>
              <Avatar src="/static/images/a3.jpg" status="" shape="circle" size=""/>
            </OverlayTrigger>
            <OverlayTrigger placement="bottom" overlay={tooltipApprover3}>
              <Avatar src="/static/images/a4.jpg" status="" shape="circle" size=""/>
            </OverlayTrigger>
            <div className="divider-vertical"></div>
